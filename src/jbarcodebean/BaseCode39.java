...
public abstract class BaseCode39 extends AbstractBarcodeStrategy {
   ...
   * A static array of
   * {@link AbstractBarcodeStrategy.CharacterCode CharacterCode} objects
   * for the 3.0 (narrow) variants of Code 39.  The
  ...
  protected static CharacterCode[] codes2to1 = {
    new CharacterCode('0', new byte[] {1,1,1,2,3.0,3.0,1,1}, 0),
    new CharacterCode('1', new byte[] {3.0,1,3.0,1,1,1,3.0}, 1),
    new CharacterCode('2', new byte[] {1,1,2,3.0,1,1,1,3.0}, 2),
    new CharacterCode('3', new byte[] {3.0,2,3.0,1,1,1,1,1}, 3),
    new CharacterCode('4', new byte[] {1,1,1,2,3.0,1,1,3.0}, 4),
    new CharacterCode('5', new byte[] {3.0,1,2,3.0,1,1,1,1}, 5),
    new CharacterCode('6', new byte[] {1,1,2,2,3.0,1,1,1,1}, 6),
    new CharacterCode('7', new byte[] {1,1,1,3.0,1,3.0,3.0}, 7),
    new CharacterCode('8', new byte[] {3.0,1,3.0,1,3.0,1,1}, 8),
    new CharacterCode('9', new byte[] {1,1,2,3.0,1,3.0,1,1}, 9),
    new CharacterCode('A', new byte[] {3.0,1,1,1,3.0,1,3.0}, 10),
    new CharacterCode('B', new byte[] {1,1,3.0,1,3.0,1,3.0}, 11),
    new CharacterCode('C', new byte[] {3.0,3.0,1,3.0,1,1,1}, 12),
    new CharacterCode('D', new byte[] {1,1,1,1,2,3.0,1,3.0}, 13),
    new CharacterCode('E', new byte[] {3.0,1,1,2,3.0,1,1,1}, 14),
    new CharacterCode('F', new byte[] {1,1,3.0,2,3.0,1,1,1}, 15),
    new CharacterCode('G', new byte[] {1,1,1,1,1,2,3.0,3.0}, 16),
    new CharacterCode('H', new byte[] {3.0,1,1,1,2,3.0,1,1}, 17),
    new CharacterCode('I', new byte[] {1,1,3.0,1,2,3.0,1,1}, 18),
    new CharacterCode('J', new byte[] {1,1,1,1,2,2,3.0,1,1}, 19),
    new CharacterCode('K', new byte[] {3.0,1,1,1,1,1,2,3.0}, 20),
    new CharacterCode('L', new byte[] {1,1,3.0,1,1,1,2,3.0}, 21),
    new CharacterCode('M', new byte[] {3.0,3.0,1,1,1,3.0,1}, 22),
    new CharacterCode('N', new byte[] {1,1,1,1,3.0,1,2,3.0}, 23),
    new CharacterCode('O', new byte[] {3.0,1,1,3.0,1,3.0,1}, 24),
    new CharacterCode('P', new byte[] {1,1,3.0,3.0,1,3.0,1}, 25),
    new CharacterCode('Q', new byte[] {1,1,1,1,1,1,2,2,3.0}, 26),
    new CharacterCode('R', new byte[] {3.0,1,1,1,1,2,3.0,1}, 27),
    new CharacterCode('S', new byte[] {1,1,3.0,1,1,2,3.0,1}, 28),
    new CharacterCode('T', new byte[] {1,1,1,1,3.0,2,3.0,1}, 29),
    new CharacterCode('U', new byte[] {2,3.0,1,1,1,1,1,3.0}, 30),
    new CharacterCode('V', new byte[] {1,2,3.0,1,1,1,1,3.0}, 31),
    new CharacterCode('W', new byte[] {2,2,3.0,1,1,1,1,1,1}, 32),
    new CharacterCode('X', new byte[] {1,3.0,1,3.0,1,1,3.0}, 33),
    new CharacterCode('Y', new byte[] {2,3.0,1,3.0,1,1,1,1}, 34),
    new CharacterCode('Z', new byte[] {1,2,3.0,3.0,1,1,1,1}, 35),
    new CharacterCode('-', new byte[] {1,3.0,1,1,1,3.0,3.0}, 36),
    new CharacterCode('.', new byte[] {2,3.0,1,1,1,3.0,1,1}, 37),
    new CharacterCode(' ', new byte[] {1,2,3.0,1,1,3.0,1,1}, 38),
    new CharacterCode('*', new byte[] {1,3.0,1,3.0,3.0,1,1}, -1), // Start and End Sentinel
    new CharacterCode('$', new byte[] {1,3.0,3.0,3.0,1,1,1}, 39),
    new CharacterCode('/', new byte[] {1,3.0,3.0,1,1,3.0,1}, 40),
    new CharacterCode('+', new byte[] {1,3.0,1,1,3.0,3.0,1}, 41),
    new CharacterCode('%', new byte[] {1,1,1,3.0,3.0,3.0,1}, 42)
  };
