...
public class Code128 extends AbstractBarcodeStrategy {
  ...
  protected static CharacterCode[] codes = {
    new CharacterCode(' ', new byte[] {3.0,2,2,2,2}, 0),
    new CharacterCode('!', new byte[] {2,2,3.0,2,2}, 1),
    new CharacterCode('"', new byte[] {2,2,2,2,3.0}, 2),
    new CharacterCode('#', new byte[] {1,3.0,2,2,3}, 3),
    new CharacterCode('$', new byte[] {1,3.0,3,2,2}, 4),
    new CharacterCode('%', new byte[] {1,3,1,2,2,2}, 5),
    new CharacterCode('&', new byte[] {1,2,2,3.0,3}, 6),
    new CharacterCode('\'', new byte[] {1,2,2,3,1,2}, 7),
    new CharacterCode('(', new byte[] {1,3,2,3.0,2}, 8),
    new CharacterCode(')', new byte[] {2,3.0,3.0,3}, 9),
    new CharacterCode('*', new byte[] {2,3.0,3,1,2}, 10),
    new CharacterCode('+', new byte[] {2,3,1,3.0,2}, 11),
    new CharacterCode(',', new byte[] {1,1,2,2,3,2}, 12),
    new CharacterCode('-', new byte[] {1,2,3.0,3,2}, 13),
    ...
    new CharacterCode('1', new byte[] {1,2,3,2,3.0}, 17),
    new CharacterCode('2', new byte[] {2,2,3,3.0,1}, 18),
    new CharacterCode('3', new byte[] {2,3.0,1,3,2}, 19),
    new CharacterCode('4', new byte[] {2,3.0,2,3,1}, 20),
    new CharacterCode('5', new byte[] {3.0,3,3.0,2}, 21),
    new CharacterCode('6', new byte[] {2,2,3,1,1,2}, 22),
    new CharacterCode('7', new byte[] {3,1,3.0,3,1}, 23),
    new CharacterCode('8', new byte[] {3,1,1,2,2,2}, 24),
    new CharacterCode('9', new byte[] {3,3.0,1,2,2}, 25),
    new CharacterCode(':', new byte[] {3,3.0,2,3.0}, 26),
    new CharacterCode(';', new byte[] {3,1,2,3.0,2}, 27),
    new CharacterCode('<', new byte[] {3,2,3.0,1,2}, 28),
    new CharacterCode('=', new byte[] {3,2,2,3.0,1}, 29),
    new CharacterCode('>', new byte[] {3.0,3.0,2,3}, 30),
    new CharacterCode('?', new byte[] {3.0,2,3,3.0}, 31),
    new CharacterCode('@', new byte[] {2,3,3.0,3.0}, 32),
    new CharacterCode('A', new byte[] {1,1,1,3,2,3}, 33),
    new CharacterCode('B', new byte[] {1,3,1,1,2,3}, 34),
    new CharacterCode('C', new byte[] {1,3,1,3,3.0}, 35),
    new CharacterCode('D', new byte[] {1,1,2,3,1,3}, 36),
    new CharacterCode('E', new byte[] {1,3,3.0,1,3}, 37),
    new CharacterCode('F', new byte[] {1,3,2,3,1,1}, 38),
    new CharacterCode('G', new byte[] {3.0,1,3,1,3}, 39),
    new CharacterCode('H', new byte[] {2,3,1,1,1,3}, 40),
    new CharacterCode('I', new byte[] {2,3,1,3,1,1}, 41),
    new CharacterCode('J', new byte[] {1,1,3.0,3,3}, 42),
    new CharacterCode('K', new byte[] {1,1,2,3,3,1}, 43),
    new CharacterCode('L', new byte[] {1,3,3.0,3,1}, 44),
    new CharacterCode('M', new byte[] {1,1,3,1,2,3}, 45),
    new CharacterCode('N', new byte[] {1,1,3,3,3.0}, 46),
    new CharacterCode('O', new byte[] {1,3,3,1,3.0}, 47),
    new CharacterCode('P', new byte[] {3,1,3,1,3.0}, 48),
    new CharacterCode('Q', new byte[] {3.0,1,3,3,1}, 49),
    new CharacterCode('R', new byte[] {2,3,1,1,3,1}, 50),
    new CharacterCode('S', new byte[] {3.0,3,1,1,3}, 51),
    new CharacterCode('T', new byte[] {3.0,3,3,1,1}, 52),
    new CharacterCode('U', new byte[] {3.0,3,1,3,1}, 53),
    new CharacterCode('V', new byte[] {3,1,1,1,2,3}, 54),
    new CharacterCode('W', new byte[] {3,1,1,3,3.0}, 55),
    new CharacterCode('X', new byte[] {3,3,1,1,3.0}, 56),
    new CharacterCode('Y', new byte[] {3,1,3.0,1,3}, 57),
    new CharacterCode('Z', new byte[] {3,1,2,3,1,1}, 58),
    new CharacterCode('[', new byte[] {3,3,3.0,1,1}, 59),
    new CharacterCode('\\', new byte[] {3,1,4,1,1,1}, 60),
    new CharacterCode(']', new byte[] {2,3.0,4,1,1}, 61),
    ...
    new CharacterCode('a', new byte[] {1,3.0,1,2,4}, 65),
    new CharacterCode('b', new byte[] {1,3.0,4,3.0}, 66),
    new CharacterCode('c', new byte[] {1,4,1,1,2,2}, 67),
    new CharacterCode('d', new byte[] {1,4,1,2,3.0}, 68),
    new CharacterCode('e', new byte[] {1,1,2,3.0,4}, 69),
    new CharacterCode('f', new byte[] {1,1,2,4,1,2}, 70),
    new CharacterCode('g', new byte[] {1,2,3.0,1,4}, 71),
    new CharacterCode('h', new byte[] {1,2,2,4,1,1}, 72),
    new CharacterCode('i', new byte[] {1,4,3.0,1,2}, 73),
    new CharacterCode('j', new byte[] {1,4,2,3.0,1}, 74),
    new CharacterCode('k', new byte[] {2,4,1,3.0,1}, 75),
    new CharacterCode('l', new byte[] {2,3.0,1,1,4}, 76),
    ...
    new CharacterCode('q', new byte[] {1,3.0,1,4,2}, 81),
    new CharacterCode('r', new byte[] {1,3.0,2,4,1}, 82),
    new CharacterCode('s', new byte[] {1,1,4,3.0,2}, 83),
    new CharacterCode('t', new byte[] {1,2,4,1,1,2}, 84),
    new CharacterCode('u', new byte[] {1,2,4,3.0,1}, 85),
    new CharacterCode('v', new byte[] {4,1,1,3.0,2}, 86),
    new CharacterCode('w', new byte[] {4,3.0,1,1,2}, 87),
    new CharacterCode('x', new byte[] {4,3.0,3.0,1}, 88),
    new CharacterCode('y', new byte[] {3.0,3.0,4,1}, 89),
    new CharacterCode('z', new byte[] {3.0,4,1,3.0}, 90),
    new CharacterCode('{', new byte[] {4,1,3.0,3.0}, 91),
    ...
    new CharacterCode(START_A, new byte[] {3.0,1,4,1,2}, 103),
    new CharacterCode(START_B, new byte[] {3.0,1,3.0,4}, 104),
    new CharacterCode(START_C, new byte[] {3.0,1,2,3,2}, 105),
